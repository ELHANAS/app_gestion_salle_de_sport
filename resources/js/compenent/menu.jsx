    ...
    return(
        <div id="menu" className="text-center ">
         <ul  className=" text-start pt-5">
                <li style={location.pathname === '/'? {background:"#ee9b57"}:{}}>
                ...
                <li style={location.pathname === '/Employe'? {background:"#ee9b57"}:{}} >
                ...
                <li style={location.pathname === '/participant'? {background:"#ee9b57"}:{}}>
                ...
                <li style={location.pathname === '/abonnement'? {background:"#ee9b57"}:{}}>
             ...
             <li style={location.pathname === '/Paiement'? {background:"#ee9b57"}:{}}>
                 <Link className="p-2"  to="/Paiement" >
                     <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                          className="bi bi-union" viewBox="0 0 16 16">
                         <path
                             d="M0 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v2h2a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-2H2a2 2 0 0 1-2-2V2z"/>
                ...
                <li style={location.pathname === '/disciplines'? {background:"#ee9b57"}:{}}>
